...
function validate ( )
{
    ...
    if ( !USERNAME.val() || USERNAME.val().length < 5  )
    {
        ...
        USERNAME_MSG.html( "El nombre de usuario debe tener 5 caracteres o más" );
        USERNAME_MSG.show();
    ...
    {
        USERNAME_MSG.html("El nombre de usuario debe estar en minúsculas");
        USERNAME_MSG.show();
        valid = false;
    }
    ...
    {
        PASSWORD_MSG.html("La contraseña debe tener al menos 8 caracteres");
        PASSWORD_MSG.show();
        valid = false;
    }
    ...
    {
        CONFIRM_MSG.html("Las contraseñas no coinciden");
        CONFIRM_MSG.show();
        valid = false;
    }
    ...
    if ( !FNAME.val() )
    {
        FNAME_MSG.html("El nombre no debe estar vacío");
        FNAME_MSG.show();
        valid = false;
    }
    ...
    if ( !LNAME.val() )
    {
        LNAME_MSG.html("El apellido no debe estar vacío");
        LNAME_MSG.show();
        valid = false;
    }
    ...
    if ( atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= x.length ) {
        EMAIL_MSG.html("Tienes que introducir una dirección de correo electrónico válida");
        EMAIL_MSG.show();
        valid = false;
    }
